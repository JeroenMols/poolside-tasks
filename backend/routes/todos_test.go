...
type createTodoTestCase struct {
	...
	responseCode  int
	responseBody  string
	databaseTodos map[string]db.TodoDatabaseItem
}
	...
	tests := []createTodoTestCase{
		{
			...
			databaseTodos: make(map[string]db.TodoDatabaseItem),
		},
		{
...
type updateTodoTestCase struct {
	...
	responseCode  int
	responseBody  string
	databaseLists map[string][]db.TodoDatabaseItem
}
	...
	tests := []updateTodoTestCase{
		{
			...
			databaseLists: map[string][]db.TodoDatabaseItem{
				existingList: {db.TodoDatabaseItem{
					Id:          "static_uuid",
